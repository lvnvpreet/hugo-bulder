...
async function checkDatabaseTables() {
  try {
    ...
    try {
      ...
      if (sampleProject) {
        console.log(`   Sample: "${sampleProject.name}" (${sampleProject.websiteType}) by ${sampleProject.user.email}`);
      }
    } catch (error: any) {
      console.log(`\n📁 Projects table: ❌ Error - ${error.message}`);
    }
    ...
    try {
      ...
      console.log(`\n🏗️ SiteGeneration table: ❌ Error - ${error.message}`);
    }
    ...
    try {
      ...
      console.log(`\n🎨 HugoTheme table: ❌ Error - ${error.message}`);
    }
    ...
    try {
      ...
      console.log(`\n🏢 BusinessCategory table: ❌ Error - ${error.message}`);
    }
    ...
    try {
      ...
      console.log(`\n🛠️ ServiceTemplate table: ❌ Error - ${error.message}`);
    }
    ...
    try {
      ...
      console.log(`\n📎 AssetUpload table: ❌ Error - ${error.message}`);
    }
    ...
    try {
      ...
      console.log(`\n🧙 WizardStep table: ❌ Error - ${error.message}`);
    }
    ...
    try {
      ...
      console.log(`\n📝 GeneratedContent table: ❌ Error - ${error.message}`);
    }
    ...
    try {
      ...
      console.log(`\n🏗️ WebsiteStructure table: ❌ Error - ${error.message}`);
    }
