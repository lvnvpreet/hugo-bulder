...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3 backdrop-blur-sm bg-white/95 dark:bg-gray-800/95">
